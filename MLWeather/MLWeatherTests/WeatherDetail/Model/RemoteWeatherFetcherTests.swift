...
class RemoteWeatherFetcherTests: XCTestCase {
    var apiRequester: APIRequester!
    var remoteWeatherFetcher: RemoteWeatherFetcher!
    ...
    override func setUp() {
        ...
        remoteWeatherFetcher = RemoteWeatherFetcher(apiRequester: apiRequester)
    }

    override func tearDown() {
        remoteWeatherFetcher = nil
        apiRequester = nil
        session = nil
        super.tearDown()
    }

    func test_fetchWeather_successfulResponse() {
        ...
        remoteWeatherFetcher.fetchWeather(latitude: 34.0194, longitude: -118.4912) { result in
            switch result {
    ...
    func test_fetchWeather_networkError() {
    ...
    func test_fetchWeather_serverError() {
    ...
    func test_fetchWeather_decodingError() {
    ...
    func test_fetchWeather_emptyData() {
    ...
    func test_fetchWeather_invalidResponse() {
